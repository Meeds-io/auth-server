...
@Service
public class OAuthRedirectWebFilter implements RootWebappFilterPlugin {

  private static final Map<String, String> REDIRECT_URIS = Map.of("/.well-known/openid-configuration",
